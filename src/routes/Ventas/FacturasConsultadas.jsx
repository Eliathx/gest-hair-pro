...
function FacturasConsultadas() {
  const [clientHistoryData, setClientHistoryData] = useState([
    ...
    },
    {
      ...
      direccion: "La Loma",
      date: "2024-03-20",
      serviceType: "Tinturado",
      amount: "$12.50",
      num: 3,
      cedula: "022999999",
      telf: "098119999",
      description: "Tinturado azul.",
      valor: 20.23,
    },
    {
      nombres: "Eliath Sebastián",
  ...
  return (
    <div style={{ margin: "5rem" }}>
      <h2>Facturas emitidas en la fecha 2024-03-20</h2>
      <div
        style={{
          display: "flex",
          alignItems: "center",
...
export default FacturasConsultadas;
